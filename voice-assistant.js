// voice-assistant.js
// Connects Farmers Assistant box to local Llama backend + adds voice
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!openBtn || !box || !header || !chatOutput || !inputField || !sendBtn) {
    console.log('Voice assistant: elements missing on this page.');
    return;
  }
  ...
  async function askLocalAI(question) {
    try {
      ...
      return 'Local AI backend नहीं मिल रहा है। कृपया जाँचें कि Python server और Ollama दोनों चालू हैं।';
    }
  }
  ...
  async function sendQuery() {
    ...
    const reply = await askLocalAI(q);
    addMessage('AI', reply);
    speak(reply);
  }
  ...
  openBtn.onclick = () => {
    ...
    if (!chatOutput.innerText.trim()) {
      const welcome = 'नमस्ते किसान जी! यह स्थानीय AI आपकी Water Health Index वेबसाइट के लिये है। pH, फसल, सिंचाई और उर्वरक से जुड़े सवाल पूछिए।';
